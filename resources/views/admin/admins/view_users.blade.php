...
@section('content')
    ...
    <div class="box">
        ...
        @if(auth()->user()->permissions == 'admin')
            ...
            <table class="table table-hover" id="users-table">
                ...
                @foreach($users as $user)
                    @section('title', trans('admin.view_user'))
                    <tr>
                        <th>{{$user->id}}</th>
                        ...
                        <td>
                            ...
                            <div class="dd-nodrag btn-group ml-auto">
                                <a href="{{url('admin/edit/user/'.$user->id)}}" class="btn btn-info btn-sm" style="margin-right: 5px">Edit</a>
                                <a href="{{url('admin/delete/user/'.$user->id)}}" class="btn btn-danger btn-sm delete">
        ...
        @elseif(auth()->user()->permissions == 'modertor')
            @section('title', trans('admin.moderators'))
            <div class="box-body table-responsive no-padding">
                <table class="table table-hover" id="users-table">
                    <tbody>
                    <tr>
